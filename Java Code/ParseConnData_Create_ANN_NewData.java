...
public class ParseConnData_Create_ANN_NewData {
   ...
   public static final String ONE_HOT_1     = "1,0,0,0";
   public static final String ONE_HOT_2     = "0,1,0,0";
   public static final String ONE_HOT_3     = "0,0,1,0";
   public static final String ONE_HOT_4     = "0,0,0,1";
         ...
         while((line=bufReader.readLine())!=null) {
            ...
            try {
               ...
               if(tactic.equalsIgnoreCase("none")) {
			    ...
			    else if(tactic.equalsIgnoreCase("Resource Development")) {
                  useRecord = true;
                  oneHot = ONE_HOT_4;
               }
