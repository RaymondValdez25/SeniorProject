...
public class ParseConnData_FollowHopsV2 {
   ...
   public static void main(String[] args) {
            ...
            if(tacticToFind.equals("") || (invertTactic && !tacticToFind.equalsIgnoreCase(tactic))
               ...
               if(useRecord) {
                  ...
                  if(!srcDstCountMap.containsKey(key)) {
                     ...
                     srcDstTacticMap.put(key,tactic);
      ...
      try {
         ...
         // file header
         bufWriter.write("rootIP,srcIP,dstIP,count,dur,bytes,hops,tactic,nCount,nDur,nBytes,end");
